...
const addBackground = (elms: any[]) => (color) => {
  elms.forEach((el) => {
...
const applyGradient = async (url: string, callback: (color: any) => void) => {
...
// RESULT
export default applyGradient(gradientAPI, addBackgroundToUnderlines);
